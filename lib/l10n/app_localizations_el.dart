...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get pairingIosSetupLimitation =>
      'Το iOS ενδέχεται να αποκλείσει τη ρύθμιση Wi-Fi για ορισμένα μοντέλα (π.χ. Wemo Mini) λόγω των περιορισμών δικτύου αξεσουάρ της Apple. Αν η ρύθμιση δεν ολοκληρωθεί, χρησιμοποιήστε μία φορά μια συσκευή Android για να το συνδέσετε στο Wi-Fi σας και, στη συνέχεια, ελέγξτε το εδώ κανονικά.';
